...
PlanPage.propTypes = {
  ...
  selectedata: PropTypes.any, 
 
};
export default function PlanPage({setdata,selectedata}){
          ...
          return (
            <tr
              ...
              className={`border-t-0 border-[#E5E5E5] cursor-pointer border-b-[1px] relative border-r-[1px] h-[50px] border-l-[1px] text-center
                ${selectedata === globalIndex ? "bg-[#EDE6F1] outline outline-[2px] outline-primary-color" : ""}`}
            ...
            >
              ...
              <td className="font-body font-normal text-[14px] leading-[19.07px]">{data.CPU}</td>
              <td className="font-body font-normal text-[14px] leading-[19.07px]">{data.Memory}</td>
              <td className="font-body font-normal text-[14px] leading-[19.07px]">{data.SSDDisk}</td>
              <td className="font-body font-normal text-[14px] leading-[19.07px]">{data.Transfer}</td>
              <td>
